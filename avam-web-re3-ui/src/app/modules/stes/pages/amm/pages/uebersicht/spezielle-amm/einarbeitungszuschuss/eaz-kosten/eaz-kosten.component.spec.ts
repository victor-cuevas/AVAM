...
import { EazKostenComponent } from './eaz-kosten.component';
import {
    CloseTabDirective,
    DbTranslatePipe,
...
describe('EazKostenComponent', () => {
    let component: EazKostenComponent;
    let fixture: ComponentFixture<EazKostenComponent>;
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(EazKostenComponent);
