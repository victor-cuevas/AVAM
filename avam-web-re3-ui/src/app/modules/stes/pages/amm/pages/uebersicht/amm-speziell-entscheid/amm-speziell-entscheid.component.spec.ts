...
import { AmmSpeziellEntscheidComponent } from './amm-speziell-entscheid.component';
...
describe('AmmSpeziellEntscheidComponent', () => {
    let component: AmmSpeziellEntscheidComponent;
    let fixture: ComponentFixture<AmmSpeziellEntscheidComponent>;
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(AmmSpeziellEntscheidComponent);
