...
import { FseKostenComponent } from './fse-kosten.component';
import {
    CloseTabDirective,
    DbTranslatePipe,
...
describe('FseKostenComponent', () => {
    let component: FseKostenComponent;
    let fixture: ComponentFixture<FseKostenComponent>;
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(FseKostenComponent);
