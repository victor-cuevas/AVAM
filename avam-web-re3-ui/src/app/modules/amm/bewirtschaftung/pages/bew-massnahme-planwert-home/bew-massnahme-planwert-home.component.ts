...
@Component({
    selector: 'avam-bew-massnahme-planwert-home',
    templateUrl: './bew-massnahme-planwert-home.component.html'
})
export class BewMassnahmePlanwertHomeComponent implements OnInit, OnDestroy {
    produktId: number;
    massnahmeId: number;
    planwertId: number;
    ...
    ngOnInit() {
        ...
        this.route.queryParams.subscribe(params => {
            ...
            this.bewirtschaftungNavigationHelper.setPlanwertStaticNavigation(PlanwerttypEnum.MASSNAHME, this.planwertId, this.massnahmeId, null);
        });
    ...
    ngOnDestroy() {
        ...
        this.facadeService.navigationService.hideNavigationTreeRoute(AmmBewirtschaftungPaths.AMM_BEWIRTSCHAFTUNG_MASSNAHME_PLANWERT);
    }
}
