...
@Component({
    selector: 'avam-bew-kurs-planwert-controllingwerte',
    templateUrl: './bew-kurs-planwert-controllingwerte.component.html',
    styleUrls: ['./bew-kurs-planwert-controllingwerte.component.scss']
})
export class BewKursPlanwertControllingwerteComponent extends Unsubscribable implements OnInit, OnDestroy {
    ...
    channel = 'kurs-planwert-controllingwerte-page';
