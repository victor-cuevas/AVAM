...
@Component({
    selector: 'avam-bew-kurs-planwert-erfassen',
    templateUrl: './bew-kurs-planwert-erfassen.component.html',
    styleUrls: ['./bew-kurs-planwert-erfassen.component.scss']
})
export class BewKursPlanwertErfassenComponent extends Unsubscribable implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.facadeService.navigationService.showNavigationTreeRoute(AmmBewirtschaftungPaths.AMM_BEWIRTSCHAFTUNG_KURS_PLANWERT_ERFASSEN, {
    ...
    getRouteData() {
        ...
        this.produktId = +this.route.parent.parent.parent.parent.snapshot.paramMap.get('produktId');
    }
    ...
    getData() {
        ...
        this.bewRestService.getKursPlanwert(this.dfeId).subscribe(res => this.handleResponse(res), () => this.deactivateSpinnerAndScrollTop());
    }
    ...
    ngOnDestroy() {
        ...
        this.facadeService.navigationService.hideNavigationTreeRoute(AmmBewirtschaftungPaths.AMM_BEWIRTSCHAFTUNG_KURS_PLANWERT_ERFASSEN);
    }
}
