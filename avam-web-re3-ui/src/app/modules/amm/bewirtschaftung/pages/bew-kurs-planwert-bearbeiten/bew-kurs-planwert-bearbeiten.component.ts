...
@Component({
    selector: 'avam-bew-kurs-planwert-bearbeiten',
    templateUrl: './bew-kurs-planwert-bearbeiten.component.html',
    styleUrls: ['./bew-kurs-planwert-bearbeiten.component.scss']
})
export class BewKursPlanwertBearbeitenComponent extends Unsubscribable implements OnInit, OnDestroy {
    ...
    channel = 'kurs-planwert-bearbeiten-channel';
    massnahmeId: number;
    planwertId: number;
        ...
        this.bewRestService.deletePlanwert(this.planwertId).subscribe(
            res => {
                if (!res.warning) {
                    ...
                    this.bewNavigationHelper.hidePlanwertStaticNavigation(PlanwerttypEnum.KURS);
