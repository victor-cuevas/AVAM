...
@Component({
    selector: 'avam-bew-kurs-beschreibung-erfassen',
    templateUrl: './bew-kurs-beschreibung-erfassen.component.html',
    providers: [PermissionContextService]
})
export class BewKursBeschreibungErfassenComponent implements AfterViewInit, OnDestroy {
