...
@Component({
    selector: 'avam-bew-produkt-planwert-bearbeiten',
    templateUrl: './bew-produkt-planwert-bearbeiten.component.html',
    styleUrls: ['./bew-produkt-planwert-bearbeiten.component.scss']
})
export class BewProduktPlanwertBearbeitenComponent extends Unsubscribable implements OnInit, OnDestroy {
    ...
    channel = 'produkt-planwert-bearbeiten-channel';
    planwertId: number;
    produktId: number;
    ...
    setupInfobar(data: PlanwertDTO) {
        this.infopanelService.dispatchInformation({
            ...
            secondTitle: this.facade.dbTranslateService.translateWithOrder(this.planwertData.produktObject, 'titel'),
        ...
        this.bewRestService.deletePlanwert(this.planwertId).subscribe(
            res => {
                if (!res.warning) {
                    ...
                    this.bewNavigationHelper.hidePlanwertStaticNavigation(PlanwerttypEnum.PRODUKT);
