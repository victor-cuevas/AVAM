...
@Component({
    selector: 'avam-bew-standort-planwert-controllingwerte',
    templateUrl: './bew-standort-planwert-controllingwerte.component.html',
    styleUrls: ['./bew-standort-planwert-controllingwerte.component.scss']
})
export class BewStandortPlanwertControllingwerteComponent extends Unsubscribable implements OnInit, OnDestroy {
    ...
    channel = 'standort-planwert-controllingwerte-page';
    ...
    private setupInfobar() {
        this.infopanelService.dispatchInformation({
            ...
            secondTitle: this.facade.dbTranslateService.translateWithOrder(this.planwertDto.durchfuehrungseinheitObject.massnahmeObject.produktObject, 'titel'),
    ...
    private getUnternehmen(): UnternehmenDTO {
        if (this.planwertDto && this.planwertDto.durchfuehrungseinheitObject.massnahmeObject && this.planwertDto.durchfuehrungseinheitObject.massnahmeObject.ammAnbieterObject) {
            return this.planwertDto.durchfuehrungseinheitObject.massnahmeObject.ammAnbieterObject.unternehmen;
        }
