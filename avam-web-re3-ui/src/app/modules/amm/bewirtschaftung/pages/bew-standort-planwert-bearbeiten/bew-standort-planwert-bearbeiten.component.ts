...
@Component({
    selector: 'avam-bew-standort-planwert-bearbeiten',
    templateUrl: './bew-standort-planwert-bearbeiten.component.html',
    styleUrls: ['./bew-standort-planwert-bearbeiten.component.scss']
})
export class BewStandortPlanwertBearbeitenComponent extends Unsubscribable implements OnInit, OnDestroy {
    ...
    channel = 'standort-planwert-bearbeiten-channel';
    massnahmeId: number;
    planwertId: number;
    ...
    setupInfobar(data: PlanwertDTO) {
        this.infopanelService.dispatchInformation({
            ...
            secondTitle: this.facade.dbTranslateService.translateWithOrder(this.planwertData.durchfuehrungseinheitObject.massnahmeObject.produktObject, 'titel'),
            subtitle: 'amm.planung.subnavmenuitem.planwertDetail'
        });
    ...
    getUnternehmen(): UnternehmenDTO {
        if (this.planwertData && this.planwertData.durchfuehrungseinheitObject.massnahmeObject && this.planwertData.durchfuehrungseinheitObject.massnahmeObject.ammAnbieterObject) {
        ...
        this.bewRestService.deletePlanwert(this.planwertId).subscribe(
            res => {
                if (!res.warning) {
                    ...
                    this.bewNavigationHelper.hidePlanwertStaticNavigation(PlanwerttypEnum.STANDORT);
