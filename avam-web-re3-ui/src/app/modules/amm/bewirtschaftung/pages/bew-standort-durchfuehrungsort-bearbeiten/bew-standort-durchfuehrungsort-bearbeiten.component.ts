...
@Component({
    selector: 'avam-bew-standort-durchfuehrungsort-bearbeiten',
    templateUrl: './bew-standort-durchfuehrungsort-bearbeiten.component.html'
})
export class BewStandortDurchfuehrungsortBearbeitenComponent implements AfterViewInit, OnDestroy, DeactivationGuarded {
    ...
    channel = 'standort-dfo-bearbeiten';
