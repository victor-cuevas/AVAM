...
@NgModule({
    declarations: [PersonalberaterDynamicAutosuggestComponent],
    exports: [PersonalberaterDynamicAutosuggestComponent],
    imports: [
        CommonModule,
        ReactiveFormsModule,
        FormsModule,
...
export class PersonalberaterDynamicAutosuggestModule {
    constructor() {}
}
