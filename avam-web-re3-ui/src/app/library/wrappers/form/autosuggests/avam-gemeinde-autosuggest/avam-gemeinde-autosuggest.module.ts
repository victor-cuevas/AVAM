...
import { AvamGemeindeAutosuggestComponent } from './avam-gemeinde-autosuggest.component';

@NgModule({
    declarations: [AvamGemeindeAutosuggestComponent],
    exports: [AvamGemeindeAutosuggestComponent],
    imports: [
        CommonModule,
        ReactiveFormsModule,
        FormsModule,
...
export class AvamGemeindeAutosuggestModule {
    constructor() {}
}
