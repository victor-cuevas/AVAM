...
describe('AvamBrancheDynamicAutosuggestComponent', () => {
    let component: AvamUnternehmenDynamicAutosuggestComponent;
    let fixture: ComponentFixture<AvamUnternehmenDynamicAutosuggestComponent>;
    ...
    beforeEach(async(() => {
        TestBed.configureTestingModule({
            declarations: [
                AvamUnternehmenDynamicAutosuggestComponent,
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(AvamUnternehmenDynamicAutosuggestComponent);
