...
import { AvamBenutzerstelleAutosuggestComponent } from './avam-benutzerstelle-autosuggest.component';
...
@NgModule({
    declarations: [AvamBenutzerstelleAutosuggestComponent],
    exports: [AvamBenutzerstelleAutosuggestComponent],
    imports: [
        CommonModule,
        ReactiveFormsModule,
        FormsModule,
...
export class AvamBenutzerstelleAutosuggestModule {
    constructor() {}
}
