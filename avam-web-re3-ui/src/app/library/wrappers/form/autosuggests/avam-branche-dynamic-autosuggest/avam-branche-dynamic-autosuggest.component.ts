...
@Component({
    selector: 'avam-branche-dynamic-autosuggest',
    templateUrl: './avam-branche-dynamic-autosuggest.component.html',
    styleUrls: ['./avam-branche-dynamic-autosuggest.component.scss']
})
export class AvamBrancheDynamicAutosuggestComponent implements OnInit {
    ...
    ngOnInit() {
        this.parentForm.statusChanges.subscribe(() => {
            if (this.parentForm.controls.branchen.value.length > 0) {
                this.branchen = this.parentForm.controls.branchen as FormArray;
