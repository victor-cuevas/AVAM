import {
    AfterViewInit, ContentChild, Directive, ElementRef, HostBinding, Input, Optional, Renderer2
} from '@angular/core';
...
@Directive({
    selector: '[customFormControlState]'
})
export class CustomFormControlStateDirective extends Unsubscribable implements AfterViewInit {
    ...
    ngAfterViewInit() {
        ...
        this.inputElement = this.elementRef.nativeElement.querySelector('.customdirective');
